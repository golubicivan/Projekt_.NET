    ...
    public class ZagrebEventsDbContext : IdentityDbContext<AppUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venue>().HasData(
                ...
                new Venue { Id = 17, Name = "Dom Sportova", Address = "Trg Krešimira Ćosića 11", Latitude = 45.8060, Longitude = 15.9540, Capacity = 6000, WorkingHours = "po programu", ContactPhone = "+38513650333", Description = "Dvorana za velike koncerte i događanja.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?w=800", LogoUrl = "/img/logos/domsportova.svg" },
