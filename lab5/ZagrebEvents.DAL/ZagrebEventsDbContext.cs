    ...
    public class ZagrebEventsDbContext : IdentityDbContext<AppUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venue>().HasData(
                ...
                new Venue { Id = 5, Name = "Boogaloo", Address = "Ulica grada Vukovara 68", Latitude = 45.8013, Longitude = 15.9869, Capacity = 1200, WorkingHours = "21:00 - 04:00", ContactPhone = "+38516313021", Description = "Klub i koncertni prostor za domaće i strane izvođače.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800", LogoUrl = "/img/logos/boogaloo-emblem.jpg", InstagramUrl = "https://www.instagram.com/boogaloozagreb/" },
                new Venue { Id = 6, Name = "Tvornica Kulture", Address = "Šubićeva 2", Latitude = 45.8146, Longitude = 16.0008, Capacity = 1000, WorkingHours = "20:00 - 04:00", ContactPhone = "+38514606650", Description = "Koncertni i klupski prostor s bogatim programom uživo.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800", LogoUrl = "/img/logos/tvornica-emblem.png", InstagramUrl = "https://www.instagram.com/tvornicakulture/" },
                ...
                new Venue { Id = 27, Name = "Osjećaj", Address = "Kačićeva 23", Latitude = 45.8086, Longitude = 15.9646, Capacity = 350, WorkingHours = "22:00 - 05:00", ContactPhone = "+385986700322", Description = "Klub i caffe bar u starom dijelu grada — slijedi osjećaj.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800", LogoUrl = "/img/logos/osjecaj.svg", InstagramUrl = "https://www.instagram.com/slijedi_osjecaj/" },
                new Venue { Id = 28, Name = "Ritz Club", Address = "Florijana Andrašeca 14", Latitude = 45.8092, Longitude = 15.9562, Capacity = 700, WorkingHours = "23:00 - 06:00", ContactPhone = "+385985525500", Description = "Glamurozni noćni klub — najbolji doživljaj zagrebačkog noćnog života.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1545128485-c400e7702796?w=800", LogoUrl = "/img/logos/ritz.svg", InstagramUrl = "https://www.instagram.com/ricklubzg/" },
                new Venue { Id = 29, Name = "THE Club", Address = "Bogovićeva 1a", Latitude = 45.8114, Longitude = 15.9759, Capacity = 400, WorkingHours = "23:00 - 05:00", ContactPhone = "+385991658675", Description = "Elegantni klub u samom centru — 'The' place to be.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1438557068880-c5f474830377?w=800", LogoUrl = "/img/logos/theclub.svg", InstagramUrl = "https://www.instagram.com/theclubzagreb/" },
                new Venue { Id = 30, Name = "Mint Club & More", Address = "Florijana Andrašeca 14", Latitude = 45.8100, Longitude = 15.9556, Capacity = 800, WorkingHours = "23:00 - 06:00", ContactPhone = "+385913900707", Description = "Klub, vrt i više od toga — mint & more.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=800", LogoUrl = "/img/logos/mint-emblem.jpg", InstagramUrl = "https://www.instagram.com/mintzagreb/" },
