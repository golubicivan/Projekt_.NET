    ...
    public class ZagrebEventsDbContext : IdentityDbContext<AppUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venue>().HasData(
                ...
                new Venue { Id = 16, Name = "Lauba", Address = "Baruna Filipovića 23a", Latitude = 45.8120, Longitude = 15.9450, Capacity = 350, WorkingHours = "11:00 - 24:00", ContactPhone = "+38516323165", Description = "Prostor za umjetnost i događanja u bivšoj tvorničkoj hali.", Type = VenueType.Bar, ImageUrl = "https://images.unsplash.com/photo-1504333638930-c8787321eee0?w=800", LogoUrl = "/img/logos/lauba.svg" },
