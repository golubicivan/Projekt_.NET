    ...
    public class ZagrebEventsDbContext : IdentityDbContext<AppUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venue>().HasData(
                ...
                new Venue { Id = 102, Name = "Noćni klub Sova", Address = "Adančeva ulica, Brckovljani (Dugo Selo)", Latitude = 45.82616, Longitude = 16.30361, Capacity = 400, WorkingHours = "22:00 - 06:00", ContactPhone = "+385911230033", Description = "Noćni klub istočno od Zagreba — party do zore.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800", LogoUrl = "/img/logos/sova.svg" },
                ...
                new Venue { Id = 104, Name = "Alcatraz Rock Bar", Address = "Preradovićeva 12", Latitude = 45.81071, Longitude = 15.97428, Capacity = 200, WorkingHours = "21:00 - 04:00", ContactPhone = "+385911230035", Description = "Rock bar i noćni klub — glasne gitare do jutra.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=800", LogoUrl = "/img/logos/alcatraz.svg" },
            ...
            modelBuilder.Entity<Event>().HasData(
                ...
                new Event { Id = 114, Name = "Alcatraz Rock Night", Description = "Živa rock svirka i glasne gitare.", StartTime = new DateTime(2026, 7, 16, 21, 0, 0), EndTime = new DateTime(2026, 7, 17, 2, 0, 0), Type = EventType.Concert, EntryPrice = 8.00m, PosterUrl = "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=600", AgeLimit = 0, VenueId = 104 },
