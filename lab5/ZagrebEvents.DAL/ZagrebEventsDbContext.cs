    ...
    public class ZagrebEventsDbContext : IdentityDbContext<AppUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venue>().HasData(
                ...
                new Venue { Id = 8, Name = "Vintage Industrial Bar", Address = "Savska cesta 160", Latitude = 45.79023, Longitude = 15.95569, Capacity = 400, WorkingHours = "19:00 - 02:00", ContactPhone = "+38598123456", Description = "Industrijski bar s koncertima indie i rock bendova.", Type = VenueType.Bar, ImageUrl = "https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=800", LogoUrl = "/img/logos/vintage-emblem.png", IdentityRequired = false },
                ...
                new Venue { Id = 102, Name = "Noćni klub Sova", Address = "Adančeva ulica, Brckovljani (Dugo Selo)", Latitude = 45.82616, Longitude = 16.30361, Capacity = 400, WorkingHours = "22:00 - 06:00", ContactPhone = "+385911230033", Description = "Noćni klub istočno od Zagreba — party do zore.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800", LogoUrl = "/img/logos/sova-emblem.jpg", InstagramUrl = "https://www.instagram.com/sova.night.club/", IdentityRequired = false },
                new Venue { Id = 103, Name = "Night Club Rocco", Address = "Andrije Hebranga 14", Latitude = 45.80943, Longitude = 15.97564, Capacity = 250, WorkingHours = "23:00 - 06:00", ContactPhone = "+385911230034", Description = "Noćni klub u srcu Donjeg grada.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1545128485-c400e7702796?w=800", LogoUrl = "/img/logos/rocco.svg", IdentityRequired = false },
                ...
                new Venue { Id = 105, Name = "Bulldog Zagreb", Address = "Bogovićeva 6", Latitude = 45.81231, Longitude = 15.97518, Capacity = 300, WorkingHours = "09:00 - 02:00", ContactPhone = "+385911230036", Description = "Legendarni pub i bar na špici.", Type = VenueType.Bar, ImageUrl = "https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=800", LogoUrl = "/img/logos/bulldog.svg", IdentityRequired = false },
            ...
            modelBuilder.Entity<Event>().HasData(
                ...
                new Event { Id = 200, Name = "Bulldog Pub Quiz", Description = "Tjedni kviz znanja na špici — ekipe do 6 igrača, prijava na šanku.", StartTime = new DateTime(2026, 7, 28, 20, 0, 0), EndTime = new DateTime(2026, 7, 28, 22, 30, 0), Type = EventType.PubQuiz, EntryPrice = 0.00m, PosterUrl = "https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=600", AgeLimit = 0, VenueId = 105 },
                new Event { Id = 201, Name = "Rooftop Sunset Session", Description = "Zalazak sunca i lagani house na krovu Ilice 16.", StartTime = new DateTime(2026, 7, 28, 20, 0, 0), EndTime = new DateTime(2026, 7, 29, 1, 0, 0), Type = EventType.DJNight, EntryPrice = 5.00m, PosterUrl = "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600", AgeLimit = 0, VenueId = 107 },
                new Event { Id = 202, Name = "Alkatraz Rock Wednesday", Description = "Rock klasici i živa svirka do kasno.", StartTime = new DateTime(2026, 7, 29, 21, 0, 0), EndTime = new DateTime(2026, 7, 30, 2, 0, 0), Type = EventType.Concert, EntryPrice = 7.00m, PosterUrl = "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=600", AgeLimit = 0, VenueId = 104 },
                new Event { Id = 203, Name = "Vintage Indie Night", Description = "Indie i alternativa uz domaće bendove.", StartTime = new DateTime(2026, 7, 29, 20, 0, 0), EndTime = new DateTime(2026, 7, 30, 0, 0, 0), Type = EventType.Concert, EntryPrice = 10.00m, PosterUrl = "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=600", AgeLimit = 0, VenueId = 8 },
                new Event { Id = 204, Name = "Katran: Warehouse Techno", Description = "Rezidentni DJ-evi i gost iz Berlina u industrijskom ambijentu.", StartTime = new DateTime(2026, 7, 30, 23, 0, 0), EndTime = new DateTime(2026, 7, 31, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 15.00m, PosterUrl = "https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=600", AgeLimit = 18, IsFeatured = true, VenueId = 9 },
                new Event { Id = 205, Name = "H2O Thursday Vibes", Description = "R'n'B i hip-hop selekcija uz koktele.", StartTime = new DateTime(2026, 7, 30, 23, 0, 0), EndTime = new DateTime(2026, 7, 31, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 10.00m, PosterUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600", AgeLimit = 18, VenueId = 25 },
                new Event { Id = 206, Name = "Boogaloo Live: Domaći Bendovi", Description = "Tri benda, jedna večer — showcase domaće scene.", StartTime = new DateTime(2026, 7, 30, 21, 0, 0), EndTime = new DateTime(2026, 7, 31, 1, 0, 0), Type = EventType.Concert, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=600", AgeLimit = 0, VenueId = 5 },
                new Event { Id = 207, Name = "H2O Friday Pure Fun", Description = "Petak u H2O — komercijalni hitovi i VIP zona.", StartTime = new DateTime(2026, 7, 31, 23, 0, 0), EndTime = new DateTime(2026, 8, 1, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 15.00m, PosterUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600", AgeLimit = 18, IsFeatured = true, VenueId = 25 },
                new Event { Id = 208, Name = "EX Balkan Night", Description = "Balkan i pop hitovi do jutra.", StartTime = new DateTime(2026, 7, 31, 23, 0, 0), EndTime = new DateTime(2026, 8, 1, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, VenueId = 26 },
                new Event { Id = 209, Name = "Ritz Glamour Friday", Description = "Glamurozna noć uz rezidentne DJ-eve.", StartTime = new DateTime(2026, 7, 31, 23, 0, 0), EndTime = new DateTime(2026, 8, 1, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 15.00m, PosterUrl = "https://images.unsplash.com/photo-1545128485-c400e7702796?w=600", AgeLimit = 18, VenueId = 28 },
                new Event { Id = 210, Name = "Mint Garden Party", Description = "House u vrtu kluba Mint.", StartTime = new DateTime(2026, 7, 31, 23, 0, 0), EndTime = new DateTime(2026, 8, 1, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 16.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, VenueId = 30 },
                new Event { Id = 211, Name = "Roko Fešta", Description = "Domaća zabava i hitovi u Club & Lounge Roko.", StartTime = new DateTime(2026, 7, 31, 23, 0, 0), EndTime = new DateTime(2026, 8, 1, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, VenueId = 31 },
                new Event { Id = 212, Name = "XO Friday Party", Description = "House i pop hitovi u Vlaškoj.", StartTime = new DateTime(2026, 7, 31, 23, 0, 0), EndTime = new DateTime(2026, 8, 1, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 10.00m, PosterUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600", AgeLimit = 18, VenueId = 101 },
                new Event { Id = 213, Name = "Rocco Weekend Opening", Description = "Otvorenje vikenda u Roccu.", StartTime = new DateTime(2026, 7, 31, 23, 0, 0), EndTime = new DateTime(2026, 8, 1, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 10.00m, PosterUrl = "https://images.unsplash.com/photo-1545128485-c400e7702796?w=600", AgeLimit = 18, VenueId = 103 },
                new Event { Id = 214, Name = "Hangar Rave: Summer Edition", Description = "Ljetni rave s europskim techno headlinerima.", StartTime = new DateTime(2026, 7, 31, 23, 0, 0), EndTime = new DateTime(2026, 8, 1, 7, 0, 0), Type = EventType.DJNight, EntryPrice = 20.00m, PosterUrl = "https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=600", AgeLimit = 18, IsFeatured = true, VenueId = 14 },
                new Event { Id = 215, Name = "Sova Night Fever", Description = "Vikend party u Sovi — do zore.", StartTime = new DateTime(2026, 7, 31, 22, 0, 0), EndTime = new DateTime(2026, 8, 1, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 8.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, VenueId = 102 },
                new Event { Id = 216, Name = "Secret Friday", Description = "Petak koji se ne priča dalje.", StartTime = new DateTime(2026, 7, 31, 23, 0, 0), EndTime = new DateTime(2026, 8, 1, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, VenueId = 108 },
                new Event { Id = 217, Name = "Bunker Techno Session", Description = "Underground techno u bunkeru ispod Ilice.", StartTime = new DateTime(2026, 7, 31, 23, 0, 0), EndTime = new DateTime(2026, 8, 1, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=600", AgeLimit = 18, VenueId = 106 },
                new Event { Id = 218, Name = "Osjećaj Petak", Description = "Slijedi osjećaj — domaći i strani hitovi.", StartTime = new DateTime(2026, 7, 31, 22, 0, 0), EndTime = new DateTime(2026, 8, 1, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 10.00m, PosterUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600", AgeLimit = 18, VenueId = 27 },
                new Event { Id = 219, Name = "Katran All Night Long", Description = "Cijela noć techna — bez pauze do jutra.", StartTime = new DateTime(2026, 8, 1, 23, 0, 0), EndTime = new DateTime(2026, 8, 2, 7, 0, 0), Type = EventType.DJNight, EntryPrice = 18.00m, PosterUrl = "https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=600", AgeLimit = 18, IsFeatured = true, VenueId = 9 },
                new Event { Id = 220, Name = "Opera Saturday", Description = "Subotnja party noć s komercijalnim hitovima.", StartTime = new DateTime(2026, 8, 1, 23, 0, 0), EndTime = new DateTime(2026, 8, 2, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600", AgeLimit = 18, VenueId = 11 },
                new Event { Id = 221, Name = "Masters R'n'B Night", Description = "R'n'B i hip-hop klasici cijelu noć.", StartTime = new DateTime(2026, 8, 1, 22, 0, 0), EndTime = new DateTime(2026, 8, 2, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 14.00m, PosterUrl = "https://images.unsplash.com/photo-1438557068880-c5f474830377?w=600", AgeLimit = 18, VenueId = 12 },
                new Event { Id = 222, Name = "THE Saturday", Description = "Elegantna subota u samom centru.", StartTime = new DateTime(2026, 8, 1, 23, 0, 0), EndTime = new DateTime(2026, 8, 2, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 15.00m, PosterUrl = "https://images.unsplash.com/photo-1438557068880-c5f474830377?w=600", AgeLimit = 18, VenueId = 29 },
                new Event { Id = 223, Name = "Aquarius Summer Night", Description = "Ljetna noć elektronske glazbe na Jarunu.", StartTime = new DateTime(2026, 8, 1, 23, 0, 0), EndTime = new DateTime(2026, 8, 2, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 20.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, IsFeatured = true, VenueId = 4 },
                new Event { Id = 224, Name = "Jarun Beach Open Air", Description = "Cjelodnevni open-air uz jezero — 8 DJ-eva, food trucks.", StartTime = new DateTime(2026, 8, 1, 18, 0, 0), EndTime = new DateTime(2026, 8, 2, 4, 0, 0), Type = EventType.Festival, EntryPrice = 25.00m, PosterUrl = "https://images.unsplash.com/photo-1506157786151-b8491531f063?w=600", AgeLimit = 0, IsFeatured = true, VenueId = 20 },
                new Event { Id = 225, Name = "Ritz Saturday Night", Description = "Subota u Ritzu uz rezidente.", StartTime = new DateTime(2026, 8, 1, 23, 0, 0), EndTime = new DateTime(2026, 8, 2, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 15.00m, PosterUrl = "https://images.unsplash.com/photo-1545128485-c400e7702796?w=600", AgeLimit = 18, VenueId = 28 },
                new Event { Id = 226, Name = "Ribnjak Chill Sunday", Description = "Nedjeljni chill u parku uz lagane ritmove.", StartTime = new DateTime(2026, 8, 2, 18, 0, 0), EndTime = new DateTime(2026, 8, 2, 23, 0, 0), Type = EventType.DJNight, EntryPrice = 0.00m, PosterUrl = "https://images.unsplash.com/photo-1506157786151-b8491531f063?w=600", AgeLimit = 0, VenueId = 23 },
                new Event { Id = 227, Name = "Rooftop Sunday Sunset", Description = "Nedjeljni zalazak na krovu.", StartTime = new DateTime(2026, 8, 2, 19, 0, 0), EndTime = new DateTime(2026, 8, 2, 23, 0, 0), Type = EventType.DJNight, EntryPrice = 0.00m, PosterUrl = "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600", AgeLimit = 0, VenueId = 107 },
                new Event { Id = 228, Name = "Bulldog Pub Quiz", Description = "Tjedni kviz znanja — nova runda pitanja.", StartTime = new DateTime(2026, 8, 3, 20, 0, 0), EndTime = new DateTime(2026, 8, 3, 22, 30, 0), Type = EventType.PubQuiz, EntryPrice = 0.00m, PosterUrl = "https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=600", AgeLimit = 0, VenueId = 105 },
                new Event { Id = 229, Name = "Rooftop Tuesday Sessions", Description = "Lagani beat i pogled na krovove Zagreba.", StartTime = new DateTime(2026, 8, 4, 20, 0, 0), EndTime = new DateTime(2026, 8, 5, 1, 0, 0), Type = EventType.DJNight, EntryPrice = 5.00m, PosterUrl = "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600", AgeLimit = 0, VenueId = 107 },
                new Event { Id = 230, Name = "Močvara Alternative Night", Description = "Alternativna i underground scena.", StartTime = new DateTime(2026, 8, 5, 20, 0, 0), EndTime = new DateTime(2026, 8, 6, 1, 0, 0), Type = EventType.Concert, EntryPrice = 8.00m, PosterUrl = "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=600", AgeLimit = 0, VenueId = 7 },
                new Event { Id = 231, Name = "Alkatraz Rock Night", Description = "Živa rock svirka i glasne gitare.", StartTime = new DateTime(2026, 8, 5, 21, 0, 0), EndTime = new DateTime(2026, 8, 6, 2, 0, 0), Type = EventType.Concert, EntryPrice = 7.00m, PosterUrl = "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=600", AgeLimit = 0, VenueId = 104 },
                new Event { Id = 232, Name = "Tvornica Live: Ljetni Koncert", Description = "Koncertna večer u Tvornici Kulture.", StartTime = new DateTime(2026, 8, 6, 20, 0, 0), EndTime = new DateTime(2026, 8, 7, 0, 0, 0), Type = EventType.Concert, EntryPrice = 18.00m, PosterUrl = "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=600", AgeLimit = 0, VenueId = 6 },
                new Event { Id = 233, Name = "Katran Underground: Techno", Description = "Rezidentna techno večer.", StartTime = new DateTime(2026, 8, 6, 23, 0, 0), EndTime = new DateTime(2026, 8, 7, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 15.00m, PosterUrl = "https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=600", AgeLimit = 18, VenueId = 9 },
                new Event { Id = 234, Name = "H2O Thursday Vibes", Description = "R'n'B i hip-hop selekcija uz koktele.", StartTime = new DateTime(2026, 8, 6, 23, 0, 0), EndTime = new DateTime(2026, 8, 7, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 10.00m, PosterUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600", AgeLimit = 18, VenueId = 25 },
                new Event { Id = 235, Name = "H2O Friday Pure Fun", Description = "Petak u H2O — komercijalni hitovi i VIP zona.", StartTime = new DateTime(2026, 8, 7, 23, 0, 0), EndTime = new DateTime(2026, 8, 8, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 15.00m, PosterUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600", AgeLimit = 18, VenueId = 25 },
                new Event { Id = 236, Name = "EX Friday Balkan", Description = "Balkan i pop program.", StartTime = new DateTime(2026, 8, 7, 23, 0, 0), EndTime = new DateTime(2026, 8, 8, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, VenueId = 26 },
                new Event { Id = 237, Name = "Ritz Glamour Friday", Description = "Glamurozni petak uz rezidentne DJ-eve.", StartTime = new DateTime(2026, 8, 7, 23, 0, 0), EndTime = new DateTime(2026, 8, 8, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 15.00m, PosterUrl = "https://images.unsplash.com/photo-1545128485-c400e7702796?w=600", AgeLimit = 18, VenueId = 28 },
                new Event { Id = 238, Name = "Mint Garden Sessions", Description = "House i techno u vrtu kluba Mint.", StartTime = new DateTime(2026, 8, 7, 23, 0, 0), EndTime = new DateTime(2026, 8, 8, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 16.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, VenueId = 30 },
                new Event { Id = 239, Name = "XO Friday Party", Description = "Petak u XO klubu.", StartTime = new DateTime(2026, 8, 7, 23, 0, 0), EndTime = new DateTime(2026, 8, 8, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 10.00m, PosterUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600", AgeLimit = 18, VenueId = 101 },
                new Event { Id = 240, Name = "Hangar Warehouse Rave", Description = "Industrijski rave do jutra.", StartTime = new DateTime(2026, 8, 7, 23, 0, 0), EndTime = new DateTime(2026, 8, 8, 7, 0, 0), Type = EventType.DJNight, EntryPrice = 22.00m, PosterUrl = "https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=600", AgeLimit = 18, IsFeatured = true, VenueId = 14 },
                new Event { Id = 241, Name = "Secret Friday", Description = "Skriveni petak za one koji znaju.", StartTime = new DateTime(2026, 8, 7, 23, 0, 0), EndTime = new DateTime(2026, 8, 8, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, VenueId = 108 },
                new Event { Id = 242, Name = "Bunker Deep Session", Description = "Deep i techno u bunkeru.", StartTime = new DateTime(2026, 8, 7, 23, 0, 0), EndTime = new DateTime(2026, 8, 8, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=600", AgeLimit = 18, VenueId = 106 },
                new Event { Id = 243, Name = "Rocco Friday Night", Description = "Vikend zabava u Roccu.", StartTime = new DateTime(2026, 8, 7, 23, 0, 0), EndTime = new DateTime(2026, 8, 8, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 10.00m, PosterUrl = "https://images.unsplash.com/photo-1545128485-c400e7702796?w=600", AgeLimit = 18, VenueId = 103 },
                new Event { Id = 244, Name = "Sova Weekend Party", Description = "Vikend u Sovi — do zore.", StartTime = new DateTime(2026, 8, 7, 22, 0, 0), EndTime = new DateTime(2026, 8, 8, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 8.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, VenueId = 102 },
                new Event { Id = 245, Name = "Roko Vikend Fešta", Description = "Domaći hitovi i zabava.", StartTime = new DateTime(2026, 8, 7, 23, 0, 0), EndTime = new DateTime(2026, 8, 8, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, VenueId = 31 },
                new Event { Id = 246, Name = "Aquarius Saturday Sessions", Description = "Subotnja elektronska noć na Jarunu.", StartTime = new DateTime(2026, 8, 8, 23, 0, 0), EndTime = new DateTime(2026, 8, 9, 7, 0, 0), Type = EventType.DJNight, EntryPrice = 20.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, IsFeatured = true, VenueId = 4 },
                new Event { Id = 247, Name = "Katran All Night Long", Description = "Techno maraton do jutra.", StartTime = new DateTime(2026, 8, 8, 23, 0, 0), EndTime = new DateTime(2026, 8, 9, 7, 0, 0), Type = EventType.DJNight, EntryPrice = 18.00m, PosterUrl = "https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=600", AgeLimit = 18, VenueId = 9 },
                new Event { Id = 248, Name = "Opera Saturday", Description = "Komercijalni hitovi i gostujući DJ.", StartTime = new DateTime(2026, 8, 8, 23, 0, 0), EndTime = new DateTime(2026, 8, 9, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600", AgeLimit = 18, VenueId = 11 },
                new Event { Id = 249, Name = "Masters Hip-Hop Night", Description = "Hip-hop i trap selekcija.", StartTime = new DateTime(2026, 8, 8, 22, 0, 0), EndTime = new DateTime(2026, 8, 9, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 14.00m, PosterUrl = "https://images.unsplash.com/photo-1438557068880-c5f474830377?w=600", AgeLimit = 18, VenueId = 12 },
                new Event { Id = 250, Name = "THE Saturday", Description = "Subota u THE Clubu.", StartTime = new DateTime(2026, 8, 8, 23, 0, 0), EndTime = new DateTime(2026, 8, 9, 5, 0, 0), Type = EventType.DJNight, EntryPrice = 15.00m, PosterUrl = "https://images.unsplash.com/photo-1438557068880-c5f474830377?w=600", AgeLimit = 18, VenueId = 29 },
                new Event { Id = 251, Name = "Šalata Summer Sessions", Description = "Ljetne DJ večeri pod zvijezdama.", StartTime = new DateTime(2026, 8, 8, 21, 0, 0), EndTime = new DateTime(2026, 8, 9, 3, 0, 0), Type = EventType.DJNight, EntryPrice = 12.00m, PosterUrl = "https://images.unsplash.com/photo-1506157786151-b8491531f063?w=600", AgeLimit = 18, VenueId = 22 },
                new Event { Id = 252, Name = "Mint Saturday Garden", Description = "Subota u vrtu Minta.", StartTime = new DateTime(2026, 8, 8, 23, 0, 0), EndTime = new DateTime(2026, 8, 9, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 16.00m, PosterUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600", AgeLimit = 18, VenueId = 30 },
                new Event { Id = 253, Name = "Maksimir Open Air Sunday", Description = "Nedjeljni open-air u parku — besplatan ulaz.", StartTime = new DateTime(2026, 8, 9, 17, 0, 0), EndTime = new DateTime(2026, 8, 9, 23, 0, 0), Type = EventType.Festival, EntryPrice = 0.00m, PosterUrl = "https://images.unsplash.com/photo-1506157786151-b8491531f063?w=600", AgeLimit = 0, IsFeatured = true, VenueId = 21 },
                new Event { Id = 254, Name = "Jarun Sunset Chill", Description = "Nedjeljni chill uz jezero.", StartTime = new DateTime(2026, 8, 9, 18, 0, 0), EndTime = new DateTime(2026, 8, 9, 23, 0, 0), Type = EventType.DJNight, EntryPrice = 0.00m, PosterUrl = "https://images.unsplash.com/photo-1506157786151-b8491531f063?w=600", AgeLimit = 0, VenueId = 20 }
            );
            ...
            // novi klubovi (XO, Sova, Rocco, Alkatraz, Bulldog, OUT Bunker, OUT Rooftop, Secret)
            foreach (var vid in new[] { 101, 102, 103, 104, 105, 106, 107, 108 }) FillClub(vid, 1);
