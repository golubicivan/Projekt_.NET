    ...
    public class ZagrebEventsDbContext : IdentityDbContext<AppUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venue>().HasData(
                ...
                new Venue { Id = 104, Name = "Alkatraz Rock Bar", Address = "Preradovićeva 12", Latitude = 45.81071, Longitude = 15.97428, Capacity = 200, WorkingHours = "21:00 - 04:00", ContactPhone = "+385911230035", Description = "Rock bar i noćni klub — glasne gitare do jutra.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=800", LogoUrl = "/img/logos/alkatraz-emblem.jpg" },
