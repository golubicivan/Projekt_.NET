...
namespace ZagrebEvents.DAL
{
    ...
    public class ZagrebEventsDbContext : IdentityDbContext<AppUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venue>().HasData(
                new Venue { Id = 4, Name = "Aquarius", Address = "Aleja Matije Ljubeka 2a, Jarun", Latitude = 45.7833, Longitude = 15.9181, Capacity = 1500, WorkingHours = "23:00 - 06:00", ContactPhone = "+38513640231", Description = "Legendarni klub na jezeru Jarun, dom elektronske glazbe u Zagrebu.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1571266028243-e4733b0f0bb0?w=800" },
                new Venue { Id = 5, Name = "Boogaloo", Address = "Ulica grada Vukovara 68", Latitude = 45.8013, Longitude = 15.9869, Capacity = 1200, WorkingHours = "21:00 - 04:00", ContactPhone = "+38516313021", Description = "Klub i koncertni prostor za domaće i strane izvođače.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800" },
                new Venue { Id = 6, Name = "Tvornica Kulture", Address = "Šubićeva 2", Latitude = 45.8146, Longitude = 16.0008, Capacity = 1000, WorkingHours = "20:00 - 04:00", ContactPhone = "+38514606650", Description = "Koncertni i klupski prostor s bogatim programom uživo.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800" },
                new Venue { Id = 7, Name = "Klub Močvara", Address = "Trnjanski nasip bb", Latitude = 45.7950, Longitude = 15.9760, Capacity = 600, WorkingHours = "20:00 - 03:00", ContactPhone = "+38516154290", Description = "Alternativni klub uz Savu, dom rock i underground scene.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=800" },
                new Venue { Id = 8, Name = "Vintage Industrial Bar", Address = "Savska cesta 160", Latitude = 45.7900, Longitude = 15.9630, Capacity = 400, WorkingHours = "19:00 - 02:00", ContactPhone = "+38598123456", Description = "Industrijski bar s koncertima indie i rock bendova.", Type = VenueType.Bar, ImageUrl = "https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=800" },
                ...
                new Venue { Id = 10, Name = "Sirup Club", Address = "Radnička cesta 21", Latitude = 45.8040, Longitude = 16.0120, Capacity = 700, WorkingHours = "23:00 - 06:00", ContactPhone = "+38591444555", Description = "House i techno klub s vrhunskim sound systemom.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1545128485-c400e7702796?w=800" },
                new Venue { Id = 11, Name = "Opera Club", Address = "Savska cesta 141", Latitude = 45.7880, Longitude = 15.9650, Capacity = 900, WorkingHours = "23:00 - 05:00", ContactPhone = "+38591666777", Description = "Mainstream klub s komercijalnim hitovima i gostujućim DJ-evima.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800" },
                new Venue { Id = 12, Name = "Masters Club", Address = "Trg Krešimira Ćosića 9", Latitude = 45.7990, Longitude = 15.9700, Capacity = 500, WorkingHours = "22:00 - 05:00", ContactPhone = "+38591888999", Description = "R'n'B i hip-hop klub u centru grada.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1438557068880-c5f474830377?w=800" },
                new Venue { Id = 13, Name = "Pločnik", Address = "Tkalčićeva 41", Latitude = 45.8150, Longitude = 15.9760, Capacity = 200, WorkingHours = "08:00 - 24:00", ContactPhone = "+38591101010", Description = "Popularni bar u Tkalči s DJ programom vikendom.", Type = VenueType.Bar, ImageUrl = "https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=800" },
                new Venue { Id = 14, Name = "Hangar", Address = "Trnjanska cesta", Latitude = 45.7900, Longitude = 15.9900, Capacity = 1000, WorkingHours = "23:00 - 08:00", ContactPhone = "+38591202020", Description = "Veliki techno prostor za rave partyje.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=800" },
                new Venue { Id = 15, Name = "Pogon Jedinstvo", Address = "Trnjanski nasip 23", Latitude = 45.7930, Longitude = 15.9780, Capacity = 600, WorkingHours = "20:00 - 04:00", ContactPhone = "+38591303030", Description = "Prostor za alternativnu i nezavisnu kulturu.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=800" },
                new Venue { Id = 16, Name = "Lauba", Address = "Baruna Filipovića 23a", Latitude = 45.8120, Longitude = 15.9450, Capacity = 350, WorkingHours = "11:00 - 24:00", ContactPhone = "+38516323165", Description = "Prostor za umjetnost i događanja u bivšoj tvorničkoj hali.", Type = VenueType.Bar, ImageUrl = "https://images.unsplash.com/photo-1504333638930-c8787321eee0?w=800" },
                new Venue { Id = 17, Name = "Dom Sportova", Address = "Trg Krešimira Ćosića 11", Latitude = 45.8060, Longitude = 15.9540, Capacity = 6000, WorkingHours = "po programu", ContactPhone = "+38513650333", Description = "Dvorana za velike koncerte i događanja.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?w=800" },
                new Venue { Id = 18, Name = "Arena Zagreb", Address = "Vice Vukova 8", Latitude = 45.7700, Longitude = 15.9430, Capacity = 15000, WorkingHours = "po programu", ContactPhone = "+38516121111", Description = "Najveća koncertna arena u Zagrebu.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1429962714451-bb934ecdc4ec?w=800" },
                new Venue { Id = 19, Name = "KD Vatroslav Lisinski", Address = "Trg Stjepana Radića 4", Latitude = 45.8020, Longitude = 15.9670, Capacity = 1850, WorkingHours = "po programu", ContactPhone = "+38516121166", Description = "Koncertna dvorana za klasičnu i ozbiljnu glazbu.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1465847899084-d164df4dedc6?w=800" },
                ...
                new Venue { Id = 23, Name = "Park Ribnjak", Address = "Ribnjak", Latitude = 45.8170, Longitude = 15.9810, Capacity = 1500, WorkingHours = "open-air", ContactPhone = "+38591808080", Description = "Gradski park s ljetnim chill događanjima.", Type = VenueType.OpenAir, ImageUrl = "https://images.unsplash.com/photo-1470770841072-f978cf4d019e?w=800" },
                new Venue { Id = 24, Name = "Eli's Caffe", Address = "Ilica 63", Latitude = 45.8110, Longitude = 15.9650, Capacity = 60, WorkingHours = "07:00 - 20:00", ContactPhone = "+38591909090", Description = "Poznata kavana specijalizirana za vrhunsku kavu.", Type = VenueType.Cafe, ImageUrl = "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=800" }
            );

            // ====== EVENTI ZA NOVE LOKACIJE (nadolazeći) ======
            modelBuilder.Entity<Event>().HasData(
                new Event { Id = 10, Name = "Aquarius Summer Opening", Description = "Veliko otvorenje ljetne sezone na Jarunu uz top elektronske DJ-eve.", StartTime = new DateTime(2026, 6, 20, 23, 0, 0), EndTime = new DateTime(2026, 6, 21, 6, 0, 0), Type = EventType.DJNight, EntryPrice = 20.00m, PosterUrl = "https://images.unsplash.com/photo-1571266028243-e4733b0f0bb0?w=600", AgeLimit = 18, VenueId = 4 },
                ...
                new Event { Id = 26, Name = "INmusic Festival", Description = "Najveći hrvatski open-air glazbeni festival na Jarunu.", StartTime = new DateTime(2026, 6, 22, 16, 0, 0), EndTime = new DateTime(2026, 6, 25, 2, 0, 0), Type = EventType.Festival, EntryPrice = 89.00m, PosterUrl = "https://images.unsplash.com/photo-1506157786151-b8491531f063?w=600", AgeLimit = 16, VenueId = 20 },
