    ...
    public class ZagrebEventsDbContext : IdentityDbContext<AppUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venue>().HasData(
                ...
                new Venue { Id = 5, Name = "Boogaloo", Address = "Ulica grada Vukovara 68", Latitude = 45.7996, Longitude = 15.9718, Capacity = 1200, WorkingHours = "21:00 - 04:00", ContactPhone = "+38516313021", Description = "Klub i koncertni prostor za domaće i strane izvođače.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800", LogoUrl = "/img/logos/boogaloo-emblem.jpg", InstagramUrl = "https://www.instagram.com/boogaloozagreb/" },
                ...
                new Venue { Id = 7, Name = "Klub Močvara", Address = "Trnjanski nasip bb", Latitude = 45.7830, Longitude = 15.9885, Capacity = 600, WorkingHours = "20:00 - 03:00", ContactPhone = "+38516154290", Description = "Alternativni klub uz Savu, dom rock i underground scene.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=800", LogoUrl = "/img/logos/mocvara-emblem.png" },
                new Venue { Id = 8, Name = "Vintage Industrial Bar", Address = "Savska cesta 160", Latitude = 45.7922, Longitude = 15.9614, Capacity = 400, WorkingHours = "19:00 - 02:00", ContactPhone = "+38598123456", Description = "Industrijski bar s koncertima indie i rock bendova.", Type = VenueType.Bar, ImageUrl = "https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=800", LogoUrl = "/img/logos/vintage-emblem.png" },
                ...
                new Venue { Id = 28, Name = "Ritz Club", Address = "Florijana Andrašeca 14", Latitude = 45.8022, Longitude = 15.9601, Capacity = 700, WorkingHours = "23:00 - 06:00", ContactPhone = "+385985525500", Description = "Glamurozni noćni klub — najbolji doživljaj zagrebačkog noćnog života.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1545128485-c400e7702796?w=800", LogoUrl = "/img/logos/ritz-emblem.jpg", InstagramUrl = "https://www.instagram.com/ricklubzg/" },
                new Venue { Id = 29, Name = "THE Club", Address = "Bogovićeva 1a", Latitude = 45.8114, Longitude = 15.9759, Capacity = 400, WorkingHours = "23:00 - 05:00", ContactPhone = "+385991658675", Description = "Elegantni klub u samom centru — 'The' place to be.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1438557068880-c5f474830377?w=800", LogoUrl = "/img/logos/theclub-emblem.jpg", InstagramUrl = "https://www.instagram.com/theclubzagreb/" },
                new Venue { Id = 30, Name = "Mint Club & More", Address = "Florijana Andrašeca 14", Latitude = 45.8016, Longitude = 15.9608, Capacity = 800, WorkingHours = "23:00 - 06:00", ContactPhone = "+385913900707", Description = "Klub, vrt i više od toga — mint & more.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=800", LogoUrl = "/img/logos/mint-emblem.jpg", InstagramUrl = "https://www.instagram.com/mintzagreb/" },
                new Venue { Id = 31, Name = "Club & Lounge Roko", Address = "Horvaćanska cesta 17a", Latitude = 45.7870, Longitude = 15.9517, Capacity = 900, WorkingHours = "23:00 - 06:00", ContactPhone = "+385976592000", Description = "Klub i lounge stvoren za zabavu.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800", LogoUrl = "/img/logos/roko-emblem.jpg", InstagramUrl = "https://www.instagram.com/club_roko/" }
            );
