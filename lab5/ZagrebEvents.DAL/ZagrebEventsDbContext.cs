    ...
    public class ZagrebEventsDbContext : IdentityDbContext<AppUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venue>().HasData(
                ...
                new Venue { Id = 5, Name = "Boogaloo", Address = "Ulica grada Vukovara 68", Latitude = 45.8013, Longitude = 15.9869, Capacity = 1200, WorkingHours = "21:00 - 04:00", ContactPhone = "+38516313021", Description = "Klub i koncertni prostor za domaće i strane izvođače.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800", LogoUrl = "/img/logos/boogaloo-emblem.jpg" },
                ...
                new Venue { Id = 25, Name = "Club H2O", Address = "Runjaninova 3", Latitude = 45.8035, Longitude = 15.9715, Capacity = 600, WorkingHours = "23:00 - 06:00", ContactPhone = "+385915100661", Description = "Ekskluzivni noćni klub u centru Zagreba — priča koja drži vodu. 'Pure fun'.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1571266028243-e4733b0f0bb0?w=800", LogoUrl = "/img/logos/h2o-emblem.jpg" },
                new Venue { Id = 26, Name = "EX Club", Address = "Izidora Kršnjavoga 1", Latitude = 45.8052, Longitude = 15.9668, Capacity = 500, WorkingHours = "23:00 - 05:00", ContactPhone = "+385981112233", Description = "Živahan klub u Donjem gradu s balkan i pop programom.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=800", LogoUrl = "/img/logos/ex.svg" },
                new Venue { Id = 27, Name = "Osjećaj", Address = "Kačićeva 23", Latitude = 45.8086, Longitude = 15.9646, Capacity = 350, WorkingHours = "22:00 - 05:00", ContactPhone = "+385986700322", Description = "Klub i caffe bar u starom dijelu grada — slijedi osjećaj.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800", LogoUrl = "/img/logos/osjecaj.svg" },
                new Venue { Id = 28, Name = "Ritz Club", Address = "Florijana Andrašeca 14", Latitude = 45.8092, Longitude = 15.9562, Capacity = 700, WorkingHours = "23:00 - 06:00", ContactPhone = "+385985525500", Description = "Glamurozni noćni klub — najbolji doživljaj zagrebačkog noćnog života.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1545128485-c400e7702796?w=800", LogoUrl = "/img/logos/ritz.svg" },
                new Venue { Id = 29, Name = "THE Club", Address = "Bogovićeva 1a", Latitude = 45.8114, Longitude = 15.9759, Capacity = 400, WorkingHours = "23:00 - 05:00", ContactPhone = "+385991658675", Description = "Elegantni klub u samom centru — 'The' place to be.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1438557068880-c5f474830377?w=800", LogoUrl = "/img/logos/theclub.svg" },
                new Venue { Id = 30, Name = "Mint Club & More", Address = "Florijana Andrašeca 14", Latitude = 45.8100, Longitude = 15.9556, Capacity = 800, WorkingHours = "23:00 - 06:00", ContactPhone = "+385913900707", Description = "Klub, vrt i više od toga — mint & more.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=800", LogoUrl = "/img/logos/mint-emblem.jpg" },
                new Venue { Id = 31, Name = "Club & Lounge Roko", Address = "Horvaćanska cesta 17a", Latitude = 45.7960, Longitude = 15.9450, Capacity = 900, WorkingHours = "23:00 - 06:00", ContactPhone = "+385976592000", Description = "Klub i lounge stvoren za zabavu.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800", LogoUrl = "/img/logos/roko-emblem.jpg" }
            );
