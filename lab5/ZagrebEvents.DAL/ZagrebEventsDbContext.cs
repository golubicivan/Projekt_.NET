...
namespace ZagrebEvents.DAL
{
    ...
    public class ZagrebEventsDbContext : IdentityDbContext<AppUser, IdentityRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Venue>().HasData(
                new Venue { Id = 4, Name = "Aquarius", Address = "Aleja Matije Ljubeka 2a, Jarun", Latitude = 45.7833, Longitude = 15.9181, Capacity = 1500, WorkingHours = "23:00 - 06:00", ContactPhone = "+38513640231", Description = "Legendarni klub na jezeru Jarun, dom elektronske glazbe u Zagrebu.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1571266028243-e4733b0f0bb0?w=800", LogoUrl = "/img/logos/aquarius.svg" },
                ...
                new Venue { Id = 6, Name = "Tvornica Kulture", Address = "Šubićeva 2", Latitude = 45.8146, Longitude = 16.0008, Capacity = 1000, WorkingHours = "20:00 - 04:00", ContactPhone = "+38514606650", Description = "Koncertni i klupski prostor s bogatim programom uživo.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800", LogoUrl = "/img/logos/tvornica.svg" },
                new Venue { Id = 7, Name = "Klub Močvara", Address = "Trnjanski nasip bb", Latitude = 45.7950, Longitude = 15.9760, Capacity = 600, WorkingHours = "20:00 - 03:00", ContactPhone = "+38516154290", Description = "Alternativni klub uz Savu, dom rock i underground scene.", Type = VenueType.Club, ImageUrl = "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=800", LogoUrl = "/img/logos/mocvara.svg" },
